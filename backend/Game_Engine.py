        ...
        try:
            while not self.check_victory():
                ...
                if key == curses.KEY_F12:
                    ...
                    action.construct_building(self.players[2].units[0], TownCenter, 4, 4, self.players[2], self.get_current_time())
                    action.construct_building(self.players[2].units[1], Barracks, 9, 4, self.players[2], self.get_current_time())
                    action.construct_building(self.players[2].units[2], House, 4, 9, self.players[2], self.get_current_time())
                    action.construct_building(self.players[2].units[3], Keep, 9, 9, self.players[2], self.get_current_time())
                elif key == ord('k'):
